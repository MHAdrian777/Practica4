...
public class TestComplejidad {
    public static void main(String[] args) {
        ...
        int resultadoBinario = ComplejidadTemporal.busquedaBinaria(Arrays.copyOf(array, array.length), objetivo);
        fin = System.nanoTime();
        ...
        if (n <= 10) {
            ...
            fin = System.nanoTime();
            System.out.println("Fibonacci exponencial O(2ⁿ): " + fibExp + "-Tiempo: " + (fin - inicio) + " ns");
        }
